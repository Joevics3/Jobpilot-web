...
function renderTemplate4(data: CVData): string {
  ...
  const css = `
    ${baseCss}
    .page { padding: 10mm 8mm; background: #ffffff; }
    .header { background: #000000; color: #ffffff; padding: 8mm; margin: -10mm -8mm 8mm -8mm; }
    .name { font-size: 28pt; font-weight: bold; color: #ffffff; margin-bottom: 3mm; }
    .title { font-size: 13pt; color: #d1d5db; margin-bottom: 3mm; }
    .contact { font-size: 9.5pt; color: #9ca3af; display: flex; flex-wrap: wrap; gap: 5mm; }
    .content {
      --section-spacing: ${spacing}mm;
      height: 217mm;
      max-height: 217mm;
    ...
    .section { margin-bottom: var(--section-spacing); page-break-inside: avoid; }
    .section:last-child { margin-bottom: 0; }
    .section-title { font-size: 13pt; font-weight: bold; color: #000000; background: #f3f4f6; padding: 2mm 4mm; margin-bottom: 4mm; text-transform: uppercase; letter-spacing: 0.5pt; }
    .experience-item, .education-item { margin-bottom: 4mm; }
    .item-header { font-weight: bold; font-size: 11pt; color: #000000; margin-bottom: 1mm; }
    .item-subheader { font-size: 9.5pt; color: #4b5563; margin-bottom: 2mm; }
    ul { margin-left: 5mm; margin-top: 2mm; }
    li { font-size: 10pt; line-height: 1.4; margin-bottom: 1mm; color: #1f2937; }
    .skills { display: flex; flex-wrap: wrap; gap: 2mm; }
    .skill { background: #000000; color: #ffffff; padding: 2mm 4mm; border-radius: 2mm; font-size: 9.5pt; font-weight: 500; }
  `;
...
export function renderCVTemplate(templateId: string, data: CVData): string {
  switch (templateId) {
    case 'template-1':
      return renderTemplate1(data);
    case 'template-2':
