...
export default function OptimizedIndividualStatePage() {
  ...
  const fetchJobsByState = async () => {
    try {
      ...
      // Simple JavaScript filtering - filter for state
      ...
      // Take first 50 jobs
      const limitedJobs = stateFilteredJobs.slice(0, 50);
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        {totalJobs > 50 && (
          <div className="mt-8 text-center">
            <p className="text-gray-600 mb-4">
              Showing 50 of {totalJobs} jobs in {formattedState}
            </p>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="bg-blue-600 rounded-lg p-8 text-white text-center">
          <h2 className="text-2xl font-bold mb-4">Looking for Jobs in Specific Towns?</h2>
          <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
            Navigate directly to town pages for more targeted job searches within {formattedState}.
          </p>
          <Link
            href="/jobs/state/"
