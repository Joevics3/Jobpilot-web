              ...
              <div className="p-5 sm:p-6">
                ...
                <div className="space-y-2 sm:space-y-3">
                  ...
                  <button
                    ...
                    onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = `${theme.colors.primary.light}30`)}
                    onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = `${theme.colors.primary.light}15`)}
                  >
                    Learn More
                  </button>
