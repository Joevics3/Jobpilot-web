...
{/* Telegram Floating Button */}
        <div className="fixed bottom-24 right-6 z-30 lg:bottom-24">
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center w-14 h-14 bg-blue-500 rounded-full shadow-lg hover:bg-blue-600 transition-all hover:scale-110 group relative"
          >
